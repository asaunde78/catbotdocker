...
class Kittyleague(commands.Cog):
    def __init__(self, bot: commands.Bot):
        ...
        with open("../leagueapi/champs/champs.json", "r") as r:
            self.champs = json.load(r)
        with open("../leagueapi/champs/aliases.json", "r") as r:
            self.aliases = json.load(r)
        with open("../leagueapi/items/items.json", "r") as r:
            self.items = json.load(r)
        with open("../leagueapi/audio/audios.json", "r") as r:
